...
export function MainContent({ selectedNote, fileSystem }: MainContentProps) {
  if (!selectedNote) {
    return (
      <div className="w-full max-w-4xl flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 mx-auto">
        <div className="text-center max-w-lg">
          <div className="mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Your personal space for thoughts, ideas, and knowledge. Select a note from the sidebar to start exploring
              your digital mind.
            </p>
          </div>
